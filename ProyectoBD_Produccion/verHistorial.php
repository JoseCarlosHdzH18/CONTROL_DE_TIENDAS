...
<body>
    ...
    <main class="contenido-centrado mt mb text-center">
        <h1 class="historial ">Historial</h1>
        <div class="mt mb">
            <table>
                <caption class="bold">PRODUCTOS COMPRADOS</caption>
                <tr class="no-hover">
                    <td>ID Compra</td>
                    <td>Fecha</td>
                    <td>Total</td>
        ...
        <div class="mt">
            <table>
                <caption class="bold">PRODUCTOS VENDIDOS</caption>
                <tr>
                    <td>ID Venta</td>
                    <td>Fecha</td>
                    <td>Total</td>
