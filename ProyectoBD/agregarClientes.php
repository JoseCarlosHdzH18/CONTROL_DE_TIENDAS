...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errores)) {
        ...
        //Insertar en la BD
        $query = "INSERT INTO clientes (NombreCliente, Telefono) VALUES ('$nombre', $telefono);";
...
<body>
    ...
    <main class="contenido-centrado mt mb">
        ...
        <form class="formulario" method="POST" action="agregarClientes.php" enctype="multipart/form-data">
            <fieldset>
